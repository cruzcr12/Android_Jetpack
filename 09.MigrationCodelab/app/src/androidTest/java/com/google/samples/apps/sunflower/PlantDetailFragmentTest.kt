...
class PlantDetailFragmentTest {
    ...
    @Rule
    @JvmField
    val composeTetRule = createAndroidComposeRule<GardenActivity>()
    ...
    fun jumpToPlantDetailFragment() {
        ...
        composeTetRule.activityRule.scenario.onActivity { gardenActivity ->
    ...
    @Test
    fun testPlantName() {
        composeTetRule.onNodeWithText("Apple").assertIsDisplayed()
    }
